...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 29, 2017 lúc 10:47 SA
...
(84, 20, '12345', '123456', 'tien@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'buy', 0),
...
(13, 'Sản phẩm 6', 10000, 20000, NULL, NULL, 1498733118418, NULL, 2, 89, '{ChiTietSanPham}', 5000, 0, '', '', ''),
...
('AEuOVayf31I4yy28xkajBrJpZYPbtRHm', 1498742812, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"isLogged":false}'),
('Ci3qdO0eB-iabRmsuPCbunPaUmZGDK1z', 1498819570, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"isLogged":true,"user":{"khachhangid":89,"matkhau":"e10adc3949ba59abbe56e057f20f883e","hoten":"Trần Văn A","diachi":"HCMC","email":"tva@gmail.com","diemdanhgia":100,"loaikhachhang":"sell"},"cart":[]}'),
('PzRI4rFmv4FlOdGp54vlp8LyZNIU3C0D', 1498752253, '{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"isLogged":false}');
...
--
ALTER TABLE `ds_xin_quyen_ban`
  MODIFY `DSXinQuyenBanId` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `san_pham`
  MODIFY `SanPhamId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

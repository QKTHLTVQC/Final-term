...
--
-- Table structure for table `bang_danh_gia`
--
...
--
-- Dumping data for table `bang_danh_gia`
--

LOCK TABLES `bang_danh_gia` WRITE;
/*!40000 ALTER TABLE `bang_danh_gia` DISABLE KEYS */;
/*!40000 ALTER TABLE `bang_danh_gia` ENABLE KEYS */;
UNLOCK TABLES;
